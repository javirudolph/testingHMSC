...
sourcePartial(fig3Scripts[3], startTag = "secondStart", endTag = "secondEnd")
prmsB2 <- bindPrms()

sourcePartial(fig3Scripts[3], startTag = "thirdStart", endTag = "thirdEnd")
prmsB3 <- bindPrms()

fig3Params$Fig3c <- str_c(prmsB1, prmsB2, prmsB3, sep = " / ")
