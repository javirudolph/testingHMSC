...
scen1pars <- prep_pars(N = 1000, D = 1, R = 15, breadth = 0.5, nicheOpt = NULL, alpha = 0.005,
...
scen3pars <- prep_pars(N = 1000, D = 1, R = 15, breadth = 0.5, nicheOpt = NULL, alpha = 0.005,
...
scen1pars <- list(scen1_a = prep_pars(N = 1000, D = 1, R = 7, breadth = 0.5, nicheOpt = NULL, alpha = 0.005,
                                      interx_col = 0, interx_ext = 0, makeRDS = FALSE),
                  scen1_b = prep_pars(N = 1000, D = 1, R = 8, breadth = 0.5, nicheOpt = NULL, alpha = 0.005,
...
scen2pars <- list(scen2_a = prep_pars(N = 1000, D = 1, R = 5, breadth = 0.5, nicheOpt = NULL, alpha = 0.001,
                                      interx_col = 0, interx_ext = 0, makeRDS = FALSE),
                  scen2_b = prep_pars(N = 1000, D = 1, R = 5, breadth = 0.5, nicheOpt = NULL, alpha = 0.005,
                                      interx_col = 0, interx_ext = 0, makeRDS = FALSE),
                  scen2_c = prep_pars(N = 1000, D = 1, R = 5, breadth = 0.5, nicheOpt = NULL, alpha = 0.015,
                                      interx_col = 0, interx_ext = 0, makeRDS = FALSE))
...
scen3pars <- list(scen3_a = prep_pars(N = 1000, D = 1, R = 5, breadth = 0.5, nicheOpt = NULL, alpha = 0.001,
                                      interx_col = 1.5, interx_ext = 1.5, makeRDS = FALSE),
                  scen3_b = prep_pars(N = 1000, D = 1, R = 5, breadth = 0.5, nicheOpt = NULL, alpha = 0.005,
                                      interx_col = 1.5, interx_ext = 1.5, makeRDS = FALSE),
                  scen3_c = prep_pars(N = 1000, D = 1, R = 5, breadth = 0.5, nicheOpt = NULL, alpha = 0.015,
                                      interx_col = 1.5, interx_ext = 1.5, makeRDS = FALSE))
...
savedate <- format(Sys.Date(), "%Y%m%d")
folderpath <- paste0("outputs/", savedate, "-fifteen_species_fig2_quadratic_nonegs/")
...
savedate <- format(Sys.Date(), "%Y%m%d")
folderpath <- paste0("outputs/", savedate, "-fifteen_species_fig3_quadratic_nonegs/")
