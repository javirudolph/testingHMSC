---
title: "Two species niche comparisons - quadratic response to environment"
...
folderpath <- "outputs/20190309-two_spp_niche_comparisons_quadratic/"
```
...
arrange_plots <- function(folderpath, scenario){
  doItAll_twosppNichecomp(outPath = folderpath, scenarioNum = scenario, indSites = FALSE) %>% 
...
```{r Scenario1, echo = FALSE, message=FALSE, fig.width=10, fig.height=6}
scenario <- "scenario1"
...
```{r Scenario2, echo = FALSE, message=FALSE, fig.width=10, fig.height=6}
scenario <- "scenario2"
...
```{r Scenario3, echo = FALSE, message=FALSE, fig.width=10, fig.height=6}
scenario <- "scenario3"
...
```{r Scenario4, echo = FALSE, message=FALSE, fig.width=10, fig.height=6}
scenario <- "scenario4"
...
```{r Scenario5, echo = FALSE, message=FALSE, fig.width=10, fig.height=6}
scenario <- "scenario5"
...
```{r Scenario6, echo = FALSE, message=FALSE, fig.width=10, fig.height=6}
scenario <- "scenario6"
...
```{r Scenario7, echo = FALSE, message=FALSE, fig.width=10, fig.height=6}
scenario <- "scenario7"
...
```{r Scenario8, echo = FALSE, message=FALSE, fig.width=10, fig.height=6}
scenario <- "scenario8"
...
```{r Scenario9, echo = FALSE, message=FALSE, fig.width=10, fig.height=6}
scenario <- "scenario9"
