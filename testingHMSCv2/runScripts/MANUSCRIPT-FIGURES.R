...
# INTRO -------------------------------------------------------------------
# FIGURES 2 AND 3 - IMAGE FILES
# Created by: Javiera Rudolph
# Date: March 25, 2019

# Warning: this is going to be a horribly long script with a bunch of functions at the beginning.
# I figured it would just be better to keep all the stuff in here, instead of trying to source a 
# script with functions specific to this manuscript's figures.
# You can use the outline feature in RStudio, to jump between the different sections.
...
params <- get_fig2_params(folderpath, scenario)
