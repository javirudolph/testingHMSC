...
outsfolderpath <- "manuscript/outputsFig2_Fig3/"
...
for(i in 1:4){
  ...
  ggsave(filename = paste0("manuscript/FigureTIFFs/", names(fig2species)[i], "species.tiff"),
...
leg <- get_legend(plot)
as_ggplot(leg)
ggsave(filename = "manuscript/FigureTIFFs/legendFig2spp.tiff", 
...
for(i in 1:4){
  ...
  ggsave(filename = paste0("manuscript/FigureTIFFs/", names(fig2sites)[i], "sites.tiff"),
         dpi = 600, units = "in", height = 5, width = 5)
...
leg <- get_legend(plot)
as_ggplot(leg)
ggsave(filename = "manuscript/FigureTIFFs/legendFig2sites.tiff", 
       dpi = 600, units = "in", width = 5)
...
ggsave("manuscript/FigureTIFFs/FIG3speciesOPTION2.tiff", width = 10, height = 5, units = "in", dpi = 100)
...
ggsave(filename = "manuscript/FigureTIFFs/FIG3species.tiff", height = 5, width = 5, units = "in", dpi = 600)

leg <- get_legend(fig3plot_spp)
as_ggplot(leg)
ggsave(filename = "manuscript/FigureTIFFs/legendFig3species.tiff", 
       dpi = 600, units = "in", width = 5)
...
ggsave(filename = "manuscript/FigureTIFFs/FIG3sites.tiff", height = 5, width = 5, units = "in", dpi = 600)

leg <- get_legend(fig3plot_sites)
as_ggplot(leg)
ggsave(filename = "manuscript/FigureTIFFs/legendFig3sites.tiff", 
       dpi = 600, units = "in", width = 5)

#Write csv files for Mathew

write.csv(fig3spp, file = "manuscript/outputsFig2_Fig3/Fig3c_species.csv")
write.csv(fig3sites, file = "manuscript/outputsFig2_Fig3/Fig3c_sites.csv")
...
tiff("manuscript/FigureTIFFs/Fig3Interactions.tiff", res = 600, width = 5, height = 15, units = "in")
par(mfrow = c(5,1))
intplot(modelfile, 1)
intplot(modelfile, 2)
intplot(modelfile, 3)
...
ggsave(filename = "manuscript/FigureTIFFs/SUP1species.tiff", height = 5, width = 5, units = "in", dpi = 600)

leg <- get_legend(fig3aplot_spp)
as_ggplot(leg)
ggsave(filename = "manuscript/FigureTIFFs/legendSUP1_species.tiff", 
       dpi = 600, units = "in", width = 5)
...
ggsave(filename = "manuscript/FigureTIFFs/SUP1sites.tiff", height = 5, width = 5, units = "in", dpi = 600)

leg <- get_legend(fig3aplot_sites)
as_ggplot(leg)
ggsave(filename = "manuscript/FigureTIFFs/legendSUP1sites.tiff", 
       dpi = 600, units = "in", width = 5)
...
ggsave(filename = "manuscript/FigureTIFFs/SUP2species.tiff", height = 5, width = 5, units = "in", dpi = 600)

leg <- get_legend(fig3bplot_spp)
as_ggplot(leg)
ggsave(filename = "manuscript/FigureTIFFs/legendSUP2_species.tiff", 
       dpi = 600, units = "in", width = 5)
...
ggsave(filename = "manuscript/FigureTIFFs/SUP2sites.tiff", height = 5, width = 5, units = "in", dpi = 600)

leg <- get_legend(fig3bplot_sites)
as_ggplot(leg)
ggsave(filename = "manuscript/FigureTIFFs/legendSUP2sites.tiff", 
       dpi = 600, units = "in", width = 5)
